...
export function StorageSection({ initial, revision, storageEnabled, onSave }: { initial: StorageConfig; revision: number; storageEnabled: boolean; onSave: (value: StorageConfig, dirty: unknown, setError?: (name: string, message: string) => void) => void }) {
