...
export function DatabaseSection({ initial, revision, directDb, onSave, onRotate }: { initial: DatabaseConfig; revision: number; directDb: boolean; onSave: (value: DatabaseConfig, dirty: unknown, setError?: (name: string, message: string) => void) => void; onRotate: () => void }) {
