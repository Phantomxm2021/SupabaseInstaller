...
export function PoolerSection({ initial, revision, enabled, onSave }: { initial: PoolerConfig; revision: number; enabled: boolean; onSave: (value: PoolerConfig, dirty: unknown, setError?: (name: string, message: string) => void) => void }) {
