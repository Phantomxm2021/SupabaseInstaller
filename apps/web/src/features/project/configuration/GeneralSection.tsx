...
type Props = { initial: GeneralConfig; revision: number; onSave: (value: GeneralConfig, dirty: unknown, setError: (name: string, message: string) => void) => void; serverErrors?: Record<string, string> }
