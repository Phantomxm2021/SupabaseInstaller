...
export interface AuthConfig { enabled: boolean; jwtExpiry: number; disableSignup: boolean; email: EmailAuthConfig; phone: PhoneAuthConfig; anonymousSignIn: boolean; redirectUrls: string[]; oauth: Record<string, OAuthProviderConfig>; smtp: SMTPConfig; rateLimits: RateLimitConfig; mfa: MFAConfig }
...
export interface RedactedAuthConfig { enabled: boolean; jwtExpiry: number; disableSignup: boolean; email: EmailAuthConfig; phone: RedactedPhoneAuthConfig; anonymousSignIn: boolean; redirectUrls?: string[]; oauth?: Record<string, RedactedOAuthProviderConfig>; smtp: RedactedSMTPConfig; rateLimits: RateLimitConfig; mfa: MFAConfig }
