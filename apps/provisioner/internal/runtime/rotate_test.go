...
func TestRotateDatabasePasswordReplayPreservesRedactedFailureDiagnostic(t *testing.T) {
	...
	replayed, err := backend.RotateDatabasePassword(context.Background(), retry)
