...
- Reconcile compares Backend, Bucket, Region, Endpoint, AccountID, and LocalPath on non-initial transitions that enable Storage and checks the previous runtime before staging. Nonzero or unavailable counts fail closed; zero permits transition.
